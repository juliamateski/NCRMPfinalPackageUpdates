NCRMP_make_size_bins <- function(region , project, years,
  ...
  if (region %in% c("FLK", "SEFCRI", "Tortugas")) {
    ...
    print("length_freq_est")
    print(length_freq_estimates)
  ...
  print("length_freq_estimates_wh")
  print(length_freq_estimates_wh)
