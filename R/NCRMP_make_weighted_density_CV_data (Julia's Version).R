...
#r <- NCRMP_make_weighted_density_CV_data(region = "STX", sppdens = NCRMP_STX_2015_23_density_species)
#print(r)

library(ncrmp.benthics.analysis)
library(tidyverse)
r <- NCRMP_make_weighted_density_CV_data(region = "SEFCRI", sppdens = NCRMP_SEFCRI_2014_22_density_species, project = "NCRMP")
print(r)
